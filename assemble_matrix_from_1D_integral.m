...
for n=1:number_of_elements
    ...
    for i = 1 : number_of_Gauss_point_x
       ...
       for m = left_element_index : right_element_index
          vertices_y=M_partition(:, T_partition(:, m)); %内部单元顶点
          ...
          elseif m == n  %具有奇异性的单元
              lower = vertices_x(1);
              upper = vertices_x(2);
              [Gauss_coefficient_y,Gauss_point_y]=generate_Gauss_local_1D(Gauss_coefficient_reference_y,Gauss_point_reference_y,lower,Gauss_point_x(i)-eps);
              for alpha=1:number_of_trial_local_basis
                  for beta=1:number_of_test_local_basis
                      temp1=Gauss_quadrature_for_1D_integral_trial_test2(coefficient_function_name,Gauss_coefficient_x(i),Gauss_point_x(i),vertices_x,trial_basis_type,alpha,trial_derivative_degree,...
                          Gauss_coefficient_y,Gauss_point_y,vertices_y,test_basis_type,beta,test_derivative_degree,1);
                      result(T_basis_test(beta,n),T_basis_trial(alpha,n))=result(T_basis_test(beta,n),T_basis_trial(alpha,n))+temp1;
                      
                      temp2=Gauss_quadrature_for_1D_integral_trial_test2(coefficient_function_name,Gauss_coefficient_x(i),Gauss_point_x(i),vertices_x,trial_basis_type,alpha,trial_derivative_degree,...
                          Gauss_coefficient_y,Gauss_point_y,vertices_y,test_basis_type,beta,test_derivative_degree,2);
                      result(T_basis_test(beta,n),T_basis_test(alpha,m))=result(T_basis_test(beta,n),T_basis_test(alpha,m))-temp2;
                  end
              end
              
              [Gauss_coefficient_y,Gauss_point_y]=generate_Gauss_local_1D(Gauss_coefficient_reference_y,Gauss_point_reference_y,Gauss_point_x(i)+eps,upper);
              for alpha=1:number_of_trial_local_basis
                  for beta=1:number_of_test_local_basis
                      temp1=Gauss_quadrature_for_1D_integral_trial_test2(coefficient_function_name,Gauss_coefficient_x(i),Gauss_point_x(i),vertices_x,trial_basis_type,alpha,trial_derivative_degree,...
                          Gauss_coefficient_y,Gauss_point_y,vertices_y,test_basis_type,beta,test_derivative_degree,1);
