function result=Gauss_quadrature_for_1D_integral_test_time(coefficient_function_name,current_time,Gauss_coefficient_local_1D,Gauss_point_local_1D,test_vertices,test_basis_type,test_basis_index,test_derivative_degree)
...
result=0;
for i=1:Gpn
     result=result+Gauss_coefficient_local_1D(i)*feval(coefficient_function_name,current_time,Gauss_point_local_1D(i))*local_basis_1D(Gauss_point_local_1D(i),test_vertices,test_basis_type,test_basis_index,test_derivative_degree);
end   